...
namespace PizzaOrder.FactoryClasses
{
	...
	{
		private readonly PizzaOrder.EntityType _typeOfEntity;
		...
		public EntityFactoryBase2(string entityName, PizzaOrder.EntityType typeOfEntity, bool isInHierarchy) : base(entityName)
		{
		...
		/// <inheritdoc/>
		public override IEntity2 CreateEntityFromEntityTypeValue(int entityTypeValue) {	return GeneralEntityFactory.Create((PizzaOrder.EntityType)entityTypeValue); }
	...
	{
		/// <summary>CTor</summary>
		public OrderEntityFactory() : base("OrderEntity", PizzaOrder.EntityType.OrderEntity, false) { }
		/// <inheritdoc/>
	...
	{
		/// <summary>CTor</summary>
		public OrderPizzaEntityFactory() : base("OrderPizzaEntity", PizzaOrder.EntityType.OrderPizzaEntity, false) { }
		/// <inheritdoc/>
	...
	{
		/// <summary>CTor</summary>
		public PizzaEntityFactory() : base("PizzaEntity", PizzaOrder.EntityType.PizzaEntity, false) { }
		/// <inheritdoc/>
	...
	{
		/// <summary>CTor</summary>
		public PizzaToppingEntityFactory() : base("PizzaToppingEntity", PizzaOrder.EntityType.PizzaToppingEntity, false) { }
		/// <inheritdoc/>
	...
	{
		/// <summary>CTor</summary>
		public ToppingEntityFactory() : base("ToppingEntity", PizzaOrder.EntityType.ToppingEntity, false) { }
		/// <inheritdoc/>
	...
	public partial class GeneralEntityFactory
	{
		...
		public static IEntity2 Create(PizzaOrder.EntityType entityTypeToCreate)
		{
	...
	public static class EntityFactoryFactory
	{
		...
		{
			foreach(int entityTypeValue in Enum.GetValues(typeof(PizzaOrder.EntityType)))
			{
				var factory = GetFactory((PizzaOrder.EntityType)entityTypeValue);
		...
		/// <summary>Gets the factory of the entity with the PizzaOrder.EntityType specified</summary>
		/// <param name="typeOfEntity">The type of entity.</param>
		/// <returns>factory to use or null if not found</returns>
		public static IEntityFactory2 GetFactory(PizzaOrder.EntityType typeOfEntity)
		{
			switch(typeOfEntity)
			{
				case PizzaOrder.EntityType.OrderEntity:
					return new OrderEntityFactory();
				case PizzaOrder.EntityType.OrderPizzaEntity:
					return new OrderPizzaEntityFactory();
				case PizzaOrder.EntityType.PizzaEntity:
					return new PizzaEntityFactory();
				case PizzaOrder.EntityType.PizzaToppingEntity:
					return new PizzaToppingEntityFactory();
				case PizzaOrder.EntityType.ToppingEntity:
	...
	{
		/// <summary>Gets the factory of the Entity type with the PizzaOrder.EntityType value passed in</summary>
		...
		{
			return new DynamicRelation(leftOperand, joinType, (PizzaOrder.EntityType)Enum.Parse(typeof(PizzaOrder.EntityType), rightOperandEntityName, false), aliasRightOperand, onClause);
		}

		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(string leftOperandEntityName, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation((PizzaOrder.EntityType)Enum.Parse(typeof(PizzaOrder.EntityType), leftOperandEntityName, false), joinType, (PizzaOrder.EntityType)Enum.Parse(typeof(PizzaOrder.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(IEntityFieldCore leftOperand, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation(leftOperand, joinType, (PizzaOrder.EntityType)Enum.Parse(typeof(PizzaOrder.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		protected override IEntityFactoryCore GetFactoryImpl(int entityTypeValue) { return EntityFactoryFactory.GetFactory((PizzaOrder.EntityType)entityTypeValue); }
