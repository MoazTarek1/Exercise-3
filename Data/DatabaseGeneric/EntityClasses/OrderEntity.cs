...
namespace PizzaOrder.EntityClasses
{
	...
	
	{
		...
		protected class OrderEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("OrderEntity", InheritanceHierarchyType.None, false, (int)PizzaOrder.EntityType.OrderEntity, typeof(OrderEntity), typeof(OrderEntityFactory), false);
				AddNavigatorMetaData<OrderEntity, EntityCollection<OrderPizzaEntity>>("OrderPizzas", a => a._orderPizzas, (a, b) => a._orderPizzas = b, a => a.OrderPizzas, () => new OrderRelations().OrderPizzaEntityUsingOrderId, typeof(OrderPizzaEntity), (int)PizzaOrder.EntityType.OrderPizzaEntity);
			}
		}
		...
		public OrderEntity(System.Int64 id) : this(id, null)
		{
		}
		...
		/// <param name="id">PK value for Order which data should be fetched into this Order object</param>
		/// <param name="validator">The custom validator object for this OrderEntity</param>
		public OrderEntity(System.Int64 id, IValidator validator)
		{
			InitClassEmpty(validator, null);
			this.Id = id;
		}
		...
		/// <remarks>Mapped on  table field: "Order"."Id".<br/>Table field type characteristics (type, precision, scale, length): Bigint, 20, 0, 0.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, true, true</remarks>
		public virtual System.Int64 Id
		{
			get { return (System.Int64)GetValue((int)OrderFieldIndex.Id, true); }
			set { SetValue((int)OrderFieldIndex.Id, value); }		}

		/// <summary>The Name property of the Entity Order<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Order"."Name".<br/>Table field type characteristics (type, precision, scale, length): Text, 0, 0, 1073741824.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.String Name
		{
			get { return (System.String)GetValue((int)OrderFieldIndex.Name, true); }
			set	{ SetValue((int)OrderFieldIndex.Name, value); }
		}
